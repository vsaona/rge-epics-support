...
/* Generated from ../O.Common/GalilTest.dbd */
...
epicsShareExtern void (*pvar_func_asynInterposeDelayRegister)(void);
epicsShareExtern void (*pvar_func_asynInterposeEchoRegister)(void);
...
epicsShareExtern void (*pvar_func_aCalcMonitorMemRegister)(void);
epicsShareExtern void (*pvar_func_acalcTotalAllocatedMemoryRegister)(void);
...
epicsShareExtern void (*pvar_func_GalilSupportRegister)(void);
...
epicsShareExtern int *pvar_int_aCalcMonitorMem_debug;
...
epicsShareExtern int *pvar_int_scanparmRecordDebug;
...
static struct iocshVarDef vardefs[] = {
	...
	{"aCalcMonitorMem_debug", iocshArgInt, (void * const)pvar_int_aCalcMonitorMem_debug},
	...
	{"scanparmRecordDebug", iocshArgInt, (void * const)pvar_int_scanparmRecordDebug},
...
int GalilTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/pi/code/epics/support/galil/3-6";
    ...
    (*pvar_func_GalilSupportRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"GalilTest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    GalilTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
