...
{
    const char *bldTop = "/home/pi/code/epics/support/autosave/R5-7-1";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"as_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    as_registerRecordDeviceDriver(*iocshPpdbbase);
}
