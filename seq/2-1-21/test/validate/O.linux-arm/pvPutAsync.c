...
# line 50 "../pvPutAsync.st"
	int i = 0;
# line 51 "../pvPutAsync.st"
	int status;
# line 52 "../pvPutAsync.st"
	for (i = 0; i < 2; i++)
	{
# line 53 "../pvPutAsync.st"
		status = seq_pvPut(ssId, 0/*x*/, SYNC);
...
# line 58 "../pvPutAsync.st"
	i = 2;
# line 59 "../pvPutAsync.st"
	seq_sync_timeout = 1.0;
# line 60 "../pvPutAsync.st"
	status = seq_pvPut(ssId, 0/*x*/, SYNC);
# line 63 "../pvPutAsync.st"
	testOk(status == pvStatTIMEOUT, "pvPut/SYNC %d, status=%d (%s)", i, status, status ? seq_pvMessage(ssId, 0/*x*/) : "");
# line 65 "../pvPutAsync.st"
	i = 3;
# line 66 "../pvPutAsync.st"
	seq_sync_timeout = 10.0;
# line 67 "../pvPutAsync.st"
	status = seq_pvPut(ssId, 0/*x*/, SYNC);
# line 70 "../pvPutAsync.st"
	testOk(status == pvStatOK, "pvPut/SYNC %d, status=%d (%s)", i, status, status ? seq_pvMessage(ssId, 0/*x*/) : "");
}
