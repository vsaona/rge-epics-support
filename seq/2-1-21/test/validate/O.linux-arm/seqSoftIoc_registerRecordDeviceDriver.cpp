...
epicsShareExtern void (*pvar_func_register_func_subThreadSleep)(void);
...
{
    const char *bldTop = "/home/pi/code/epics/support/seq/2-1-21";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"seqSoftIoc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
